"""
run_training.py: create a model (mlp,gcn,sgcn,rgcn,graphsage,graphsaint) and train it
...
def main():    
    ...
    if run_test:
        print("Run test")
        utils.test_model( model, test_data, device, writer, test_sample_size, guard )
